...
namespace Orcs_Plus
{
    public class I_OrcHeaddress : Item
    {
        ...
        {
            return "A heavy wood and cloth headdress resembling carved to resemble an orc, but still identifiably different to any familiar with orc faces. You gain +" + (int)(xpModifier * 100) + "% XP when completing challenges relating to Orcs, and, while in an orc camp, your profile is always at its minimum.(max of only one will have effect per agent)." + (doublesHeld ? "[DISABLED]" : "");
        }
