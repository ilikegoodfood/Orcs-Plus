...
namespace Orcs_Plus
{
    public class Rti_DrinkGrott : Ritual
    {
        ...
        {
            return "Grott is a thick orc beverage that is served scalding hot from a fire. It's taste is reportedly foul beyond measure, but it is said to fortify the body of those who drink it. When travelling beyond their homeland, orcs will sometimes transport grott in drinking horns, such as this one, for later consumption.";
        }
