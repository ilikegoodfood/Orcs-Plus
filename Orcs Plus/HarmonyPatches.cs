...
namespace Orcs_Plus
{
    public static class HarmonyPatches
    {
        ...
        private static void Patching()
        {
            ...
            harmony.Patch(original: AccessTools.Constructor(typeof(UAE_Warlord), new Type[] { typeof(Location), typeof(Society) }), postfix: new HarmonyMethod(patchType, nameof(UAEN_OrcWarlord_ctor_Postfix)));
        ...
        {
            if (ua.location.getNeighbours().Any(n => n.soc == ua.society && n.settlement != null && (n.settlement is Set_OrcCamp || (n.settlement.subs.Any(sub => sub is Sub_OrcWaystation way && way.orcSociety == ua.society)))))
            {
                result = true;
            }
